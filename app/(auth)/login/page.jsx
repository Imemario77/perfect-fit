    ...
    <div className={lato_7.className}>
      <div className="w-full h-full bg-[#F7F7F7] overflow-hidden flex md:flex-row flex-col">
        <motion.div
          ...
          className="h-[100vh] flex-1 flex justify-center items-center"
        >
          <Image
            src={Logo_img}
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500 peer"
            ...
            />
            <Link href="/reset" className="self-end text-sm text-hint pr-2">
          ...
          <Link href="/signup" className="my-2 text-[15px] text-primary">
            Create an account
          </Link>
